    ...
    <section id="wrapper" class="error-page">
        <div class="error-box">
            <div class="error-body text-center">
                <h1>403</h1>
                <h3 class="text-uppercase">Permission Denide !</h3>
                <p class="text-muted m-t-30 m-b-30">YOU SEEM TO BE TRYING TO FIND HIS WAY BACK</p>
                <a href="{{url()->previous()}}" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">Go Back</a>
            </div>
            <footer class="footer text-center"> © {{date('Y')}} प्रदेश सभा सचिवालय </footer>
        </div>
    </section>
    <!-- ============================================================== -->
    <!-- End Wrapper -->
